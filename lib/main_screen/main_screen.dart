          ...
          Expanded(
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snap) {
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      final whoIsForAdmin = itemTypeForAdmin
                          .where((element) =>
                              element['seller'] == shopSold[index]['userEmail'])
                          .toList();
                ...
                *
                * */
                      var totalEmployeeSoldBale_5 = employeeSoldDayFilter
                          .map((e) => e['bale_5'])
                          .toList();
                ...
                *
                * */
                      var totalEmployeeSoldBale_10 = employeeSoldDayFilter
                          .map((e) => e['bale_10'])
                          .toList();
                ...
                * */
                      ...
                      Provider.of<DailyProductionData>(context).totalSoldData(
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (ctx) => ProductDeliveredToShopInput(
                                    loggedUser: shopSold[index]['userEmail'],
                                  ),
                                ),
                              );
                            },
